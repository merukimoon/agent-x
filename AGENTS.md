...
### Reference Guide
1. Start with `assistant-agents/canonical.md`, the single source of truth for how assistant prompts are structured, how assumptions are handled, and what output format is required.
2. Consult the adapter for the assistant you are invoking:
   * `assistant-agents/codex.md`
   * `assistant-agents/claude.md`
   * `assistant-agents/gemini.md`
