...
export const USAGE = [
    "Usage:",
    "  agentic agent <agentName> --run <RUN_ID> [--dry-run]",
    "  agentic flow --run <RUN_ID> [--dry-run]",
    "  agentic validate --run <RUN_ID>",
    "  agentic retry --run <RUN_ID> --step <STEP_ID>",
    "  agentic skip --run <RUN_ID> --step <STEP_ID>",
    "  agentic status --run <RUN_ID>",
].join("\n");
