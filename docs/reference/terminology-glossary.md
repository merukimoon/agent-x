...
Definition: Domain-specific agents pulled into flows as needed: Architect, Tech Lead, DBA, DevOps, Data Scientist, QA, Technical Writer, Legal, CISO, PR Reviewer, and others defined under `domain/roles/`.  
...
Definition: A structured list of required actions or validations per agent (see `domain/roles/*/checklists.md`).  
